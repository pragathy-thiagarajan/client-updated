...
import { getAdminUsers, getAdminBookings } from "../../api/adminApi";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-500">
            Monitor users, events, bookings and transactions.
          </p>
        </div>
        ...
        <div className="mt-6">
          <h2 className="mb-4 text-xl font-semibold">User Overview</h2>

          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
            <StatCard title="Users" value={userCount} />

            <StatCard title="Organizers" value={organizerCount} />

            <StatCard title="Admins" value={adminCount} />

            <StatCard title="Active" value={activeUsers} />

            <StatCard title="Blocked" value={blockedUsers} />
          </div>
        </div>
        ...
        <div className="mt-6">
          <h2 className="mb-4 text-xl font-semibold">Booking Overview</h2>

          <div className="grid gap-5 sm:grid-cols-3">
            <StatCard title="Confirmed" value={confirmedBookings} />

            <StatCard title="Cancelled" value={cancelledBookings} />

            <StatCard title="Paid" value={paidBookings} />
          </div>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm shadow-slate-200/60">
          <h2 className="mb-5 text-xl font-semibold">Admin Actions</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="mt-4 text-sm font-medium">{users.length} users →</p>
            </Link>
            ...
            >
              ...
              <p className="mt-1 text-sm text-slate-500">
                View bookings and attendee transactions.
              </p>
            ...
            >
              <h3 className="font-semibold">Event Approval</h3>

              <p className="mt-1 text-sm text-slate-500">
                Review and approve organizer events.
              </p>

              <p className="mt-4 text-sm font-medium">Manage Events →</p>
            </Link>
            <Link
              to="/admin/support"
              className="rounded-lg border bg-violet-100 p-5 transition hover:bg-violet-50"
            >
              ...
              <p className="mt-4 text-sm font-medium">View Inquiries →</p>
            </Link>

            <Link
              to="/admin/feedback"
              className="rounded-lg border bg-rose-100 p-5 transition hover:bg-rose-50"
            >
              <h3 className="font-semibold">Attendee Feedback</h3>

              <p className="mt-1 text-sm text-slate-500">
                Review attendee ratings and event feedback.
              </p>

              <p className="mt-4 text-sm font-medium">View Feedback →</p>
            </Link>
          </div>
        </div>
